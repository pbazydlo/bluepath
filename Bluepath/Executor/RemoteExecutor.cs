                ...
                if (this.joinThread == null)
                {
                    this.joinThread = new Thread(
                        async () =>
                        {
                            ...
                            {
                                // TODO: Expose method to do 'Pulse' on synchronization object after the callback is received
                                // TODO: Check for buffered callbacks that we may have missed before RemoteExecutor.Join was called
